...
{    
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        HTML.Tag parentTag = HTMLHelper.getTag(parentElem.getName());
        ...
        {            
            ...
            {                
                ...
                else //not a list
                {
                    ...
                    {
                     // This causes parser issues.
                     //   insertImpliedBR(e);
                     // Just insert a normal newline character.
    ...
    private void insertImpliedBR(ActionEvent e)
    {
        HTMLEditorKit.InsertHTMLTextAction hta =
            new HTMLEditorKit.InsertHTMLTextAction("insertBR",
                "<br></br>", HTML.Tag.IMPLIED, HTML.Tag.BR);
    ...
    /**
     * Inserts a paragraph after the current paragraph that will be
     * of the same type.
     * 
     * @param elem
     * @param editor
     ...
     */
    public void insertParagraphAfter(Element elem, JEditorPane editor) 
    throws BadLocationException, java.io.IOException
    {
        ...
        int newPosition = insertParagraphAfter(document, editor.getEditorKit(), elem, cr);
     ...
     * @param elem The element that will have a paragraph inserted after.
     * @param position The position of the caret.
     * @return The new position of the caret after insertion.
     * @throws BadLocationException
     * @throws java.io.IOException
     */
    public static int insertParagraphAfter(HTMLDocument document, EditorKit editorKit, Element elem, int position) 
    throws BadLocationException, java.io.IOException
    {
        int cr = position;
        HTML.Tag t = HTMLHelper.getTag(elem.getName());
        ...
        //if this is an implied paragraph, make the new para a div
        ...
        // This is the end of the element, so switch to the new tag element, which is by default a paragraph.
        if(cr == endOffs - 1)
        {
            html += createBlock(HTML.Tag.P, elem, "");
        }
        else
        {
            StringWriter out = new StringWriter();
    ...
    protected static String createBlock(HTML.Tag t, Element elem, String html)
    {
    ...
    protected static void setCharAttribs(Element p, AttributeSet chAttribs)
    {
