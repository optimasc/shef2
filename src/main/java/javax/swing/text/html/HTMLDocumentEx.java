...
/** A full copy of HTMLDocument modified to fix some
 *  bugs and make some procedures and fields protected
 *  instead of private so they can easily be overrided.
 *
 * @author Carl Eric Codere
 *
 */
public class HTMLDocumentEx extends HTMLDocument {
     ...
     * unexpected results.
     */
    protected void insertHTML(Element parent, int offset, String html,
     ...
     * is of length 1.
     */
    protected void removeElements(Element e, int index, int count) throws BadLocationException {
        writeLock();
        try {
     ...
     */
    protected void removeElementsAtEnd(Element e, int index, int count,
     ...
     */
    void replace(DefaultDocumentEvent dde, Element e, int index,
     ...
     */
    protected void removeElements(Element e, int index, int count,
                             int start, int end) throws BadLocationException {
        Element[] removed = new Element[count];
     ...
     * or not.
     */
    protected boolean frameDocument = false;
    protected boolean preservesUnknownTags = true;
    ...
    public class HTMLReader extends HTMLEditorKit.ParserCallback {
        ...
        HTMLReader(int offset, int popDepth, int pushDepth,
            ...
            this.offset = offset;
            threshold = HTMLDocumentEx.this.getTokenThreshold();
          ...
          //  tagMap.put(HTML.Tag.NOBR, ca);
            ...
            if (!emptyDocument && !midInsert) {
                ...
                Element elem =
                        HTMLDocumentEx.this.getCharacterElement(targetOffset);
                ...
                if (attrs != null) {
                    ...
                    if (tagToInsertInto != null) {
                        this.inParagraph = HTMLHelper.isParagraph(tagToInsertInto);
                    }
                }
            }
        }
        ...
        public void flush() throws BadLocationException {
            if (emptyDocument && !insertAfterImplied) {
                if (HTMLDocumentEx.this.getLength() > 0 ||
                                      parseBuffer.size() > 0) {
                    flushBuffer(true);
                    adjustEndElement();
                }
        ...
        public void handleText(char[] data, int pos) {
            ...
            if(HTMLDocumentEx.this.getProperty(I18NProperty).equals( Boolean.FALSE ) ) {
                // if a default direction of right-to-left has been specified,
                // we want complex layout even if the text is all left to right.
                Object d = getProperty(TextAttribute.RUN_DIRECTION);
                if ((d != null) && (d.equals(TextAttribute.RUN_DIRECTION_RTL))) {
                    HTMLDocumentEx.this.putProperty( I18NProperty, Boolean.TRUE);
                } else {
        ...
        class HeadAction extends BlockAction {
            ...
            private void handleLink(AttributeSet attr) {
                ...
                if (type.equals("text/css")) {
                    ...
                    /** This is a horrible hack, we need to go through
                     *  each attribute, since HTML.Attribute.MEDIA
                     *  is not public, to get the HTML.Attribute.MEDIA
                     *  value
                     */
                    ...
                    while (names.hasMoreElements()) 
                    {
                      ...
                      if (key.toString().equals("media"))
                      {
                        media = (String)attr.getAttribute(key);
                        break;
                      }
                    }                    
                    if (media == null) {
        ...
        void flushBuffer(boolean endOfStream) throws BadLocationException {
            int oldLength = HTMLDocumentEx.this.getLength();
            ...
            offset += HTMLDocumentEx.this.getLength() - oldLength;
            flushCount++;
        }
        ...
        protected boolean insertAfterImplied;
        ...
        protected boolean wantsTrailingNewline;
        int threshold;
        int offset;
