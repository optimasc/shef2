...
public class LinkPanel extends HTMLAttributeEditorPanel
{
    ...
    {
        this(new Hashtable<String,String>(), urlFieldEnabled);
    }
    ...
    public void updateComponentsFromAttribs()
    {
        ...
        if(attribs.containsKey(HTMLHelper.Attributes.HREF))         //$NON-NLS-1$
            urlField.setText(attribs.get(HTMLHelper.Attributes.HREF).toString()); //$NON-NLS-1$
        else 
    ...
    public void updateAttribsFromComponents()
    {
        ...
        attribs.put(HTMLHelper.Attributes.HREF, urlField.getText());               //$NON-NLS-1$
    }
