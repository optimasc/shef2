...
public class HTMLElementPropertiesAction extends HTMLTextEditAction
{
    ...
    public HTMLElementPropertiesAction()
    {
        ...
        addShouldBeEnabledDelegate(new ShouldBeEnabledDelegate()
        {
            ...
            {                          
                return getEditMode() != SOURCE && HTMLUtils.elementAtCaretPosition(getCurrentEditor()) != null;
            }
        });
    }
    ...
    {
        Element elem = HTMLUtils.elementAtCaretPosition(ed);
    ...
    private void editListProps(Element elem)
    {
        ...
        if(elem == null)
           return;
        int type;
        if(elem.getName().equalsIgnoreCase("ul"))
            type = ListDialog.UNORDERED;
        else if(elem.getName().equalsIgnoreCase("ol"))
