...
public class HTMLInlineAction extends HTMLTextEditAction
{
    ...
    public static final int KBD = 11;
    public static final int SAMP = 12;
    ...
    {        
        ...
        i18n.str("italic"),
        i18n.str("underline"),
        i18n.str("striketrough"),
        i18n.str("definition"),
        i18n.str("user input"),
        i18n.str("console output"),
        i18n.str("variable"),
        i18n.str("teletype")
    };
    ...
    private static final int[] MNEMS =
    {
        ...
        i18n.mnem("italic"),
        i18n.mnem("underline"),
        i18n.mnem("striketrough"),
        i18n.mnem("definition"),
        i18n.mnem("user input"),
        i18n.mnem("console output"),
        i18n.mnem("variable"),
        i18n.mnem("teletype")
    };
    ...
    private void toggleStyle(JEditorPane editor)
    {
        ...
        {
          if(type == BOLD)
            HTMLUtils.attributeHelper.setBold(attr, true);
          else if(type == ITALIC)
            HTMLUtils.attributeHelper.setItalic(attr, true);
          else if(type == STRIKE)
            HTMLUtils.attributeHelper.setStrikeThrough(attr, true);
          else if(type == SUP)
            HTMLUtils.attributeHelper.setSuperscript(attr, true);
          else if(type == SUB)
            HTMLUtils.attributeHelper.setSubscript(attr, true);
          else
          /* Other elements that are directly tags. */
