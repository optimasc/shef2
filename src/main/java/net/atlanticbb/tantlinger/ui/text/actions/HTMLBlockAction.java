...
{    
    ...
    private static final int KEYS[] =
    {
        ...
        KeyEvent.VK_R, KeyEvent.VK_Q, KeyEvent.VK_N, KeyEvent.VK_U,KeyEvent.VK_A
    };
    ...
    {               
        ...
        {            
            ...
            { 
                caret = changeBlockType(editor, e);
            }
    ...
    private int changeBlockType(JEditorPane editor, ActionEvent e) 
    throws BadLocationException
    {
        return HTMLUtils.changeBlockType((HTMLDocument)editor.getDocument(), (HTMLEditorKit)editor.getEditorKit(), getTag(),  
