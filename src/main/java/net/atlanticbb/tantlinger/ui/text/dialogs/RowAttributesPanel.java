...
public class RowAttributesPanel extends HTMLAttributeEditorPanel
{
    ...
    {
        if(attribs.containsKey(HTMLHelper.Attributes.BGCOLOR))
        {
            bgColorPanel.setSelected(true);
            bgColorPanel.setColor(attribs.get(HTMLHelper.Attributes.BGCOLOR).toString());
        }
    ...
    public void updateAttribsFromComponents()
    {
        if(bgColorPanel.isSelected())
            attribs.put(HTMLHelper.Attributes.BGCOLOR, bgColorPanel.getColor());
        else
            attribs.remove(HTMLHelper.Attributes.BGCOLOR);
